...
class treinoC(models.Model):
    nome = models.ForeignKey('aluno', on_delete=models.DO_NOTHING, default=None, verbose_name="Aluno")
    cexc_1 = models.CharField(max_length=100, blank=True, null=True, verbose_name="1")
    crep1 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_2 = models.CharField(max_length=100, blank=True, null=True, verbose_name="2")
    crep2 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_3 = models.CharField(max_length=100, blank=True, null=True, verbose_name="3")
    crep3 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_4 = models.CharField(max_length=100, blank=True, null=True, verbose_name="4")
    crep4 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_5 = models.CharField(max_length=100, blank=True, null=True, verbose_name="5")
    crep5 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_6 = models.CharField(max_length=100, blank=True, null=True, verbose_name="6")
    crep6 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_7 = models.CharField(max_length=100, blank=True, null=True, verbose_name="7")
    crep7 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_8 = models.CharField(max_length=100, blank=True, null=True, verbose_name="8")
    crep8 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_9 = models.CharField(max_length=100, blank=True, null=True, verbose_name="9")
    crep9 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_10 = models.CharField(max_length=100, blank=True, null=True, verbose_name="10")
    crep10 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_11 = models.CharField(max_length=100, blank=True, null=True, verbose_name="11")
    crep11 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_12 = models.CharField(max_length=100, blank=True, null=True, verbose_name="12")
    crep12 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')



class treinoD(models.Model):
    nome = models.ForeignKey('aluno', on_delete=models.DO_NOTHING, default=None, verbose_name="Aluno")
    dexc_1 = models.CharField(max_length=100, blank=True, null=True, verbose_name="1")
    drep1 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_2 = models.CharField(max_length=100, blank=True, null=True, verbose_name="2")
    drep2 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_3 = models.CharField(max_length=100, blank=True, null=True, verbose_name="3")
    drep3 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dxc_4 = models.CharField(max_length=100, blank=True, null=True, verbose_name="4")
    drep4 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_5 = models.CharField(max_length=100, blank=True, null=True, verbose_name="5")
    drep5 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_6 = models.CharField(max_length=100, blank=True, null=True, verbose_name="6")
    drep6 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_7 = models.CharField(max_length=100, blank=True, null=True, verbose_name="7")
    drep7 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_8 = models.CharField(max_length=100, blank=True, null=True, verbose_name="8")
    drep8 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_9 = models.CharField(max_length=100, blank=True, null=True, verbose_name="9")
    drep9 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_10 = models.CharField(max_length=100, blank=True, null=True, verbose_name="10")
    drep10 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_11 = models.CharField(max_length=100, blank=True, null=True, verbose_name="11")
    drep11 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    dexc_12 = models.CharField(max_length=100, blank=True, null=True, verbose_name="12")
    drep12 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')



class treinoE(models.Model):
    nome = models.ForeignKey('aluno', on_delete=models.DO_NOTHING, default=None, verbose_name="Aluno")
    cexc_1 = models.CharField(max_length=100, blank=True, null=True, verbose_name="1")
    crep1 = models.CharField(max_length=6, blank=True, null=True, verbose_name='RP')
    cexc_2 = models.CharField(max_length=100, blank=True, null=True, verbose_name="2")
